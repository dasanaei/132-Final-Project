function [y] = Project_M4PiecewiseCalcHeat_014_07(t, yh, yl, ts, tau)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ENGR 132 
% Program Description 
% Determines piecewise function output for first order function. HEAT
%
% Function Call
% [y] = Project_M4PiecewiseCalcHeat_014_07(t, yh, yl, ts, tau)
%
% Input Arguments
% t - time vector (sec)
